...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)("blocks.registerBlockType", "attributeCommander/attribute", addCustomAttributes);
...
const withAttributeControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    if (!props.isSelected) {
    ...
    const isBlockLocked = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.useSelect)(select => {
      const {
        canMoveBlock,
        canRemoveBlock,
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockEdit, {
    ...
    }, Object.entries(props.attributes.attributesMap).map(([locator, data]) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalHStack, {
      alignment: "top"
      ...
      onChange: newLocator => {
        if (Object.keys(props.attributes.attributesMap).includes(newLocator)) {
          return;
        }
        props.setAttributes({
          attributesMap: !newLocator && Object.entries(data).length === 0 ? removeObjectProperty(props.attributes.attributesMap, locator) : renameObjectProperty(props.attributes.attributesMap, locator, newLocator)
        });
      }
    ...
    }, "Add attribute")), Object.entries(data).map(([key, value]) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      style: {
        marginTop: "-16px"
      }
      ...
      onChange: newKey => {
        ...
        props.setAttributes({
          attributesMap: {
            ...(props.attributes.attributesMap || {}),
            [locator]: !newKey && !value ? removeObjectProperty(data, key) : renameObjectProperty(data, key, newKey)
          }
        });
      }
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__.addFilter)("editor.BlockEdit", "attributeCommander/controls", withAttributeControls);
/******/ })()
;
